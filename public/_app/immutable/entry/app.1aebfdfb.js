...
const re = [
		() =>
			k(
				() => import('../nodes/0.a6ca449c.js'),
				[
					'..\\nodes\\0.a6ca449c.js',
					'..\\chunks\\index.05b97c2d.js',
					'..\\chunks\\stores.cfdaed92.js',
					'..\\chunks\\singletons.ef050840.js',
					'..\\chunks\\index.22269ec3.js',
		...
		() =>
			k(
				() => import('../nodes/2.533e06fc.js'),
				[
					'..\\nodes\\2.533e06fc.js',
					'..\\chunks\\index.05b97c2d.js',
					'..\\chunks\\index.22269ec3.js',
					'..\\assets\\2.265a38f0.css'
				],
				import.meta.url
			),
		() =>
			k(
				() => import('../nodes/3.5d4c2b23.js'),
				[
					'..\\nodes\\3.5d4c2b23.js',
	...
	oe = [],
	ae = { '/': [2], '/about': [3], '/sverdle': [-5], '/sverdle/how-to-play': [5] },
	le = {
		handleError: ({ error: a }) => {
			console.error(a);
		}
